...
# http://real-chart.finance.yahoo.com/table.csv?s=SPY&a=00&b=01&c=2015&d=12&e=30&f=2015&ignore=.csv
{
  ...
  printf("%s; wget -nv -O %s/%s.csv 'http://real-chart.finance.yahoo.com/table.csv?s=%s&a=%s&b=%s&c=%s&d=%s&e=%s&f=%s&g=%s&ignore=.csv'\n",
    CMD_SLEEP, DIR_OUTPUT, NAME, NAME, A, B, C, D, E, F, G)
}
