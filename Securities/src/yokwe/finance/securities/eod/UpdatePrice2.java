...
public class UpdatePrice2 {
	private static final org.slf4j.Logger logger = LoggerFactory.getLogger(UpdatePrice2.class);
	...
	private static final int MAX_ELAPSED_TIME_IN_MINUTES = 55; // 55 minutes
	private static final int WAIT_TIME_IN_MINUTES        = 5;  // 5 minutes
	private static final int OLD_COUNT_ALLOWED           = 10; // allow 10 old symbols
