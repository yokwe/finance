...
import yokwe.finance.stock.data.Stats;
import yokwe.finance.stock.data.Stock;
import yokwe.finance.stock.util.DoubleArray;
import yokwe.finance.stock.util.DoubleStreamUtil;
import yokwe.finance.stock.util.DoubleUtil;
import yokwe.finance.stock.util.HV;
import yokwe.finance.stock.util.MA;
import yokwe.finance.stock.util.RSI;
